...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isBrowser) {
        ...
        // Modo CEF: começa OCULTO, espera evento celularShow
        elements.phoneContainer.style.display = 'none';
        ...
        // Handshake: avisa o Pawn que o JS carregou (resolve /celular que não aparece em devices lentos)
        sendCefEvent('celularReady', '1');
        console.log('[Celular2] Modo CEF - aguardando celularShow (celularReady enviado)');
    }
});
